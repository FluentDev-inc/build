...
""" % bcb_dev)
  ...
  is_extreme = target_info.GetBuildProp("org.fluent.version").endswith(
        "_extreme")
  android_version = target_info.GetBuildProp("ro.build.version.release")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("org.fluent.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.fluent.device")
  script.PrintFluentBanner(is_plus, android_version, build_id, build_date,
